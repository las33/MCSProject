...
Parameters.base_binary = 'tree'; %usa o svm
%Parameters.base_binary = ''; usa o que estiver em base_classifier
Parameters.fracrej=0.05;
Parameters.sigma=5;


[data_train, labels_train] = load_data('C:\Users\leona\Documents\Mestrado_code\MCSProject\ProcessedBases\Penbased\penbased_1_train.csv');
%classifiers = run_base_classifier(svdd, data_train, labels_train, 0.0045, 5);

[data_test, labels_test] = load_data('C:\Users\leona\Documents\Mestrado_code\MCSProject\ProcessedBases\Penbased\penbased_1_test.csv');
